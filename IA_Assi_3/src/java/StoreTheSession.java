...
public class StoreTheSession extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            HashMap<String,HttpSession> MySessionManager = (HashMap) MyApplicationScope.getAttribute("MySessionManager");
            MySessionManager.put(CurrentSession.getId().toString(), CurrentSession);
            
            Cookie MyCookie = new Cookie("MyCurrentSession",CurrentSession.getId().toString());
